...
if menuResult == "pythonHugo":
  ...
  writeFileFromArray("/home/pi/autorun.sh", [
    ...
    chromiumPath + " --incognito --start-maximized --no-default-browser-check --disable-popup-blocking --check-for-update-interval=31536000 --user-agent=\"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.130 Safari/537.36\" " + URL + " > /dev/null 2>&1",
    restartOrShutdown
  ])
